...
`)
	cmd.Flags().StringVar(&flags.Options.ExtraEtcd, "extra-etcd", flags.Options.ExtraEtcd, `extra etcd`)
	cmd.Flags().Uint32Var(&flags.Options.ExtraEtcdPort, "extra-etcd-port", flags.Options.ExtraEtcdPort, `extra etcd`)
